...
def create_hists_for_site(site):
    ...
    axes[0].imshow(dsd_hist.T, origin='lower', cmap='viridis', aspect='auto', norm=LogNorm(vmin=1, vmax=25000), extent=[dsd_xedges[0], dsd_xedges[-1], dsd_yedges[0], dsd_yedges[-1]])
...
#     axes[0].set_ylim((0, 1000))
    ...
    axes[1].imshow(vvd_hist.T, origin='lower', cmap='Purples', aspect='auto',  extent=[vvd_xedges[0], vvd_xedges[-1], vvd_yedges[0], vvd_yedges[-1]])
    ...
    axes[2].imshow(rho_hist.T, origin='lower', cmap='Greens', aspect='auto', extent=[rho_xedges[0], rho_xedges[-1], rho_yedges[0], rho_yedges[-1]])
