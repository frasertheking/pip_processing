...
def sanity_check(site, pip_path, mrr_path, match_dates):
    ...
    if match_dates:
        ...
        m_dates.to_csv(site + '_matched_dates.csv')
        return
    ...
    def create_hists_for_site(site, match_dates):
        ...
        np.save('../../data/processed/' + site + '_avg_ze.npy', np.nanmean(avg_ze, axis=0))
        np.save('../../data/processed/' + site + '_avg_dv.npy', np.nanmean(avg_dv, axis=0))
        np.save('../../data/processed/' + site + '_avg_sw.npy', np.nanmean(avg_sw, axis=0))
        np.save('../../data/processed/' + site + '_avg_dsd.npy', np.nanmean(avg_dsd, axis=0))
        np.save('../../data/processed/' + site + '_avg_vvd.npy', np.nanmean(avg_vvd, axis=0))
        np.save('../../data/processed/' + site + '_avg_rho.npy', np.nanmean(avg_rho, axis=0))
