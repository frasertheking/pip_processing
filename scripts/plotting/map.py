...
site_lats = [46.532, 44.908, 61.845, 69.058, 59.81, 67.84, 37.665, 42.686]
site_lons = [-87.548, -84.719, 24.287, -152.863, 7.21, 20.41, 128.7, -73.823]
names = ['MQT', 'APX', 'FIN', 'NSA', 'HAUK', 'KIR', 'KO2', 'IMPACTS']
snowing_minutes = [580949, 45295, 78636, 95268, 24939, 81112, 9843, 0]
colors = ['black', 'r', 'g', 'b', 'orange', 'c', 'm', 'yellow']  # colors for each site
