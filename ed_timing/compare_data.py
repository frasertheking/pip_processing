...
H1, xedges1, yedges1 = np.histogram2d(merged_data["ed"], merged_data["rho"], bins=512)
axs[0].pcolormesh(xedges1, yedges1, H1.T, cmap='viridis', norm=LogNorm(vmin=5, vmax=500))
...
H2, xedges2, yedges2 = np.histogram2d(merged_data["adj_ed"], merged_data["rho"], bins=512)
axs[1].pcolormesh(xedges2, yedges2, H2.T, cmap='viridis', norm=LogNorm(vmin=5, vmax=500))
