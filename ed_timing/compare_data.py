...
def make_hist_for_site(site, subfolders):
    ...
    im1 = axs[0].pcolormesh(xedges1, yedges1, H1.T, cmap='viridis', norm=LogNorm(vmin=3, vmax=500))
    ...
    im2 = axs[1].pcolormesh(xedges2, yedges2, H2.T, cmap='viridis', norm=LogNorm(vmin=3, vmax=500))
