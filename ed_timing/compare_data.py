...
hb1 = axarr[0].hexbin(valid_rho, valid_ed, gridsize=1000, cmap='viridis', bins='log')#, vmin=1, vmax=100)
...
hb2 = axarr[1].hexbin(valid_rho, valid_ed_fixed, gridsize=1000, cmap='viridis', bins='log')#, vmin=1, vmax=100)
